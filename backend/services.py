...
async def process_document(file: UploadFile, enable_chunking: bool = True, 
                          chunk_size: int = 2000) -> DocumentResponse:
...
"""
    ...
    def extract_sources_from_response(self, response: str, search_results: List[SearchResult] = None, 
